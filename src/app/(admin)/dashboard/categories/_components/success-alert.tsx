...
export function CategorySuccessAlert() {
  ...
  useEffect(() => {
    ...
    if (created === "true") {
      setMessage("Category has been successfully created!");
      setIsVisible(true);
    } else if (updated === "true") {
      setMessage("Category has been successfully updated!");
      setIsVisible(true);
    } else if (deleted === "true") {
      setMessage("Category has been successfully deleted!");
      setIsVisible(true);
    }
