...
export function AdminSuccessAlert() {
  ...
  useEffect(() => {
    ...
    if (created === "true") {
      setMessage("Admin has been successfully created!");
      setIsVisible(true);
    } else if (updated === "true") {
      setMessage("Admin has been successfully updated!");
      setIsVisible(true);
    } else if (deleted === "true") {
      setMessage("Admin has been successfully deleted!");
      setIsVisible(true);
    }
