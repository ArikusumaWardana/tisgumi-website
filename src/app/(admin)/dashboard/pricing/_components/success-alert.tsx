...
export function PricingSuccessAlert() {
  ...
  useEffect(() => {
    ...
    if (created === "true") {
      setMessage("Custom pricing has been successfully created!");
      setIsVisible(true);
    } else if (updated === "true") {
      setMessage("Custom pricing has been successfully updated!");
      setIsVisible(true);
    } else if (deleted === "true") {
      setMessage("Custom pricing has been successfully deleted!");
      setIsVisible(true);
    }
